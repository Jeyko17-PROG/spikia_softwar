    ...
    public function handle(): int
    {
        ...
        $query->get()->each(function (Sesion $sesion) use (&$archived) {
            ...
            try {
                ...
                // No dejar que un fallo al registrar el evento (p. ej. user_id nulo, que
                // session_usage_events.user_id exige por FK) bloquee el archivado de esta
                // sesion ni del resto del lote. Mismo criterio que recordSessionUsage() en
                // SesionController.
            }
