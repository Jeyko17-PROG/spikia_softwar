...
<div class="flex flex-col h-screen bg-black text-white font-sans overflow-hidden relative">
    ...
    <div class="fixed bottom-24 left-4 z-50 sm:bottom-8 sm:left-8">
    ...
    <div class="fixed bottom-8 right-8 z-50">
        <button id="toggle-audio-btn" type="button" aria-label="Activar audio" class="relative flex items-center justify-center gap-2.5 rounded-full bg-zinc-900 border border-cyan-400/30 px-5 py-3.5 text-[11px] font-black uppercase tracking-[0.16em] text-zinc-200 shadow-[0_0_30px_rgba(0,210,255,0.15)] transition-all active:scale-90 overflow-hidden group">
            ...
            <span id="audio-btn-label" class="relative whitespace-nowrap">Activar audio</span>
        </button>
    </div>
